...
/**
 * Page Splash - Écran géant d'accueil
 * Effets spéciaux : "Bienvenue" doré pulsant + Nom événement avec cœurs flottants
 */
...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .hero-bg {
        ...
        z-index: 0;
        background: url('fond.jpg') center center / cover no-repeat;
    ...
    .wave:nth-child(1) {
        background: radial-gradient(ellipse at center, rgba(247, 151, 30, 0.3) 0%, transparent 70%);
        animation-duration: 12s; bottom: -15%;
    }
    .wave:nth-child(2) {
        background: radial-gradient(ellipse at center, rgba(255, 210, 0, 0.2) 0%, transparent 70%);
        animation-duration: 18s; animation-delay: -3s; bottom: -25%; width: 250%; height: 250%;
    }
    .wave:nth-child(3) {
        background: radial-gradient(ellipse at center, rgba(247, 151, 30, 0.15) 0%, transparent 70%);
        animation-duration: 22s; animation-delay: -6s; bottom: -10%; width: 180%; height: 180%;
    }
    .wave:nth-child(4) {
        background: radial-gradient(ellipse at center, rgba(255, 107, 107, 0.08) 0%, transparent 70%);
        animation-duration: 14s; animation-delay: -8s; bottom: -30%; width: 220%; height: 220%;
    }
    ...
    .particle-advanced {
        position: absolute;
        opacity: 0;
        animation: floatParticleAdvanced linear infinite;
    }
    ...
    .particle-advanced.shooting-star {
        position: absolute;
    ...
    .particle-advanced.shooting-star::after {
        content: '';
        position: absolute;
        top: 50%; right: 0;
        width: 80px; height: 1px;
        background: linear-gradient(to left, rgba(247, 151, 30, 0.3), transparent);
    ...
    @keyframes floatParticleAdvanced {
        ...
        8%   { opacity: 0.8; }
        15%  { transform: translateY(85vh) rotate(12deg) scale(1); opacity: 1; }
        85%  { opacity: 0.7; }
        100% { transform: translateY(-10vh) rotate(-18deg) scale(0.5); opacity: 0; }
    }

    @keyframes shootingStar {
        0%   { transform: translate(0, 0) scale(0); opacity: 0; }
        5%   { opacity: 1; transform: translate(-100px, 100px) scale(1); }
        10%  { opacity: 1; transform: translate(-200px, 200px) scale(0.8); }
        15%  { opacity: 0; transform: translate(-300px, 300px) scale(0); }
    ...
    /* ============================================
       ⭐ NOM DE L'ÉVÉNEMENT AVEC EFFETS SPÉCIAUX AMOUR
       ============================================ */
    .event-title-wrapper {
        position: relative;
    ...
    /* Halo doré pulsant autour du titre */
    .event-title::before {
        content: '';
        position: absolute;
        inset: -10px -20px;
        background: radial-gradient(ellipse at center,
            rgba(247, 151, 30, 0.25) 0%,
    ...
    @keyframes heartFloat {
        ...
        50% {
            transform: translate(5px, -10px) scale(1.3) rotate(15deg);
            opacity: 1;
        }
    }

    /* Texte avec dégradé animé multicolore */
    ...
    .floating-heart {
        ...
        opacity: 0;
        animation: floatHeartUp 4s ease-out infinite;
    ...
    .floating-heart:nth-child(even) {
        color: #ffd200;
        text-shadow: 0 0 15px rgba(255, 210, 0, 0.7),
    ...
    @keyframes floatHeartUp {
        ...
        15% {
            opacity: 0.9;
            transform: translateY(-15px) translateX(5px) scale(1) rotate(10deg);
        }
        50% {
            opacity: 1;
            transform: translateY(-60px) translateX(-8px) scale(1.1) rotate(-15deg);
        }
        85% {
            opacity: 0.6;
            transform: translateY(-100px) translateX(10px) scale(0.8) rotate(20deg);
        }
        100% {
            transform: translateY(-130px) translateX(-5px) scale(0.4) rotate(-10deg);
            opacity: 0;
        }
    }

    /* Scintillement sur le texte */
    .event-title .highlight::after {
        content: '';
        position: absolute;
        inset: 0;
    ...
    .host-photo-wrapper {
        ...
        box-shadow: 0 0 80px rgba(247, 151, 30, 0.2);
    ...
    .host-photo-wrapper:hover {
        transform: scale(1.03);
        border-color: rgba(247, 151, 30, 0.9);
        box-shadow: 0 0 100px rgba(247, 151, 30, 0.35);
    }

    @keyframes logoPulse {
        0%, 100% { transform: scale(1); box-shadow: 0 0 60px rgba(247, 151, 30, 0.15); }
        50%      { transform: scale(1.04); box-shadow: 0 0 90px rgba(247, 151, 30, 0.3); }
    }
    ...
    .divider .line {
        flex: 1; height: 1px;
        background: linear-gradient(90deg, transparent, rgba(247, 151, 30, 0.2), transparent);
    }
    ...
    .logo-badge {
        ...
        box-shadow: 0 0 40px rgba(247, 151, 30, 0.25),
                    inset 0 0 30px rgba(247, 151, 30, 0.08);
    ...
    .logo-badge::before {
        ...
        inset: -4px;
        border-radius: 50px;
        background: linear-gradient(135deg, rgba(247, 151, 30, 0.4), rgba(255, 210, 0, 0.3));
        opacity: 0;
        z-index: -1;
    ...
    @keyframes badgePulse {
        ...
        50% {
            ...
            box-shadow: 0 0 60px rgba(247, 151, 30, 0.4),
                        inset 0 0 40px rgba(247, 151, 30, 0.15);
        }
    }
    ...
    #currentGuestCard .guest-card {
        ...
        border: 1px solid rgba(247, 151, 30, 0.10);
        border-radius: 30px;
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    #currentGuestCard .guest-card:hover {
    ...
    #currentGuestCard .guest-card:hover .guest-photo {
        border-color: #f7971e;
        box-shadow: 0 0 120px rgba(247, 151, 30, 0.35);
    ...
    #currentGuestCard .guest-card:hover .guest-photo-default {
        border-color: #f7971e;
        transform: scale(1.02);
    }
    ...
    @media (max-width: 1024px) {
        .hero-content { padding: 20px 30px; gap: 25px; }
        .left-column { max-width: 40%; padding-right: 15px; }
        .right-column { max-width: 60%; padding-left: 15px; }

        .event-title-wrapper { padding: 15px 20px; }
        .event-title { font-size: 36px; }
        .floating-heart { font-size: 14px; }
        .floating-heart:nth-child(3n) { font-size: 16px; }
        .event-title::after { font-size: 16px; }

        .host-photo-slider { width: 150px; height: 150px; }
        .host-photo-wrapper .logo-placeholder { font-size: 48px; }

        .welcome-message { font-size: 17px; }
        ...
        #currentGuestCard .guest-photo,
        #currentGuestCard .guest-photo-default { width: 220px; height: 220px; }
        #currentGuestCard .guest-photo-default { font-size: 68px; }
        #currentGuestCard .guest-name { font-size: 36px; }
        #currentGuestCard .guest-card { max-width: 480px; padding: 28px 20px 24px; }
    }
    ...
    @media (max-width: 820px) {
        ...
        .event-title-wrapper { padding: 10px 15px; }
        .event-title { font-size: 28px; }
        .floating-heart { font-size: 12px; }
        .floating-heart:nth-child(even) { font-size: 10px; }
        .floating-heart:nth-child(3n) { font-size: 14px; }
        .event-title::after { font-size: 14px; top: -15px; }

        .host-photo-slider { width: 100px; height: 100px; margin-bottom: 8px; }
        .host-photo-wrapper .logo-placeholder { font-size: 36px; }
        .host-photo-indicator { margin-top: 4px; }
        .host-photo-dot { width: 6px; height: 6px; }

        .welcome-message { font-size: 14px; max-width: 100%; margin: 2px auto 6px; }
        .welcome-message .heart-icon { font-size: 14px; }
        .event-date { font-size: 10px; padding: 3px 14px; margin: 2px auto 4px; }
        .divider { max-width: 150px; margin: 4px auto 6px; }
        ...
        .logo-badge i { font-size: 14px; }

        .guest-slider { padding: 4px 0; }

        #currentGuestCard .guest-card { max-width: 400px; padding: 20px 16px 18px; border-radius: 22px; }
        #currentGuestCard .guest-photo,
        #currentGuestCard .guest-photo-default { width: 160px; height: 160px; margin-bottom: 10px; }
        #currentGuestCard .guest-photo-default { font-size: 50px; }
        #currentGuestCard .guest-name { font-size: 28px; }
        #currentGuestCard .guest-event { font-size: 13px; }
        #currentGuestCard .guest-status { font-size: 13px; padding: 4px 18px; margin-top: 6px; }
        .slide-position { font-size: 12px; margin-top: 6px; }
        .refresh-counter { bottom: 12px; right: 12px; font-size: 9px; padding: 3px 10px; }
    }

    @media (max-width: 480px) {
        .hero-content { padding: 10px 12px; gap: 6px; }
        .left-column { padding-bottom: 8px; }

        .event-title-wrapper { padding: 8px 10px; }
        .event-title { font-size: 22px; }
        .floating-heart { font-size: 9px; }
        .floating-heart:nth-child(even) { font-size: 8px; }
        .floating-heart:nth-child(3n) { font-size: 11px; }
        .event-title::after { font-size: 11px; top: -10px; }

        .host-photo-slider { width: 80px; height: 80px; margin-bottom: 4px; }
        .host-photo-wrapper { border-width: 3px; }
        .host-photo-wrapper .logo-placeholder { font-size: 28px; }
        .host-photo-indicator { margin-top: 2px; gap: 4px; }
        .host-photo-dot { width: 5px; height: 5px; }

        .welcome-message { font-size: 12px; margin: 1px auto 4px; line-height: 1.4; }
        .welcome-message .heart-icon { font-size: 12px; }
        .event-date { font-size: 8px; padding: 2px 10px; gap: 4px; }
        .event-date i { font-size: 10px; }
        .divider { max-width: 100px; gap: 8px; margin: 2px auto 4px; }
        .divider .diamond { font-size: 7px; }
        ...
        .logo-badge i { font-size: 11px; }

        #currentGuestCard .guest-card { max-width: 320px; padding: 14px 10px 12px; border-radius: 16px; }
        #currentGuestCard .guest-photo,
        #currentGuestCard .guest-photo-default { width: 120px; height: 120px; margin-bottom: 6px; border-width: 3px; }
        #currentGuestCard .guest-photo-default { font-size: 38px; }
        #currentGuestCard .guest-name { font-size: 20px; }
        #currentGuestCard .guest-event { font-size: 11px; }
        #currentGuestCard .guest-event .nb-pers { font-size: 10px; }
        #currentGuestCard .guest-status { font-size: 11px; padding: 3px 12px; margin-top: 4px; gap: 4px; }
        #currentGuestCard .guest-status i { font-size: 12px; }
        .slide-position { font-size: 10px; margin-top: 4px; }
        .waiting-state .icon { font-size: 40px; }
        .waiting-state h3 { font-size: 18px; }
        .waiting-state p { font-size: 12px; }
        .waiting-state .spinner { width: 28px; height: 28px; }
        .refresh-counter { bottom: 8px; right: 8px; font-size: 8px; padding: 2px 8px; }
    }

    @media (max-width: 380px) {
        .event-title-wrapper { padding: 6px 8px; }
        .event-title { font-size: 18px; }
        .floating-heart { font-size: 8px; }
        .floating-heart:nth-child(3n) { font-size: 9px; }
        .event-title::after { font-size: 9px; top: -8px; }
        ...
        #currentGuestCard .guest-photo,
        #currentGuestCard .guest-photo-default { width: 100px; height: 100px; }
        #currentGuestCard .guest-photo-default { font-size: 32px; }
        #currentGuestCard .guest-name { font-size: 17px; }
        #currentGuestCard .guest-card { padding: 10px 8px 8px; }
        .welcome-message { font-size: 11px; }
        .host-photo-slider { width: 65px; height: 65px; }
        .host-photo-wrapper .logo-placeholder { font-size: 22px; }
    }

    @media (prefers-reduced-motion: reduce) {
        .particle-advanced { animation: none !important; display: none; }
        .wave { animation: none !important; }
        .host-photo-wrapper { animation: none !important; }
        .welcome-message .heart-icon { animation: none !important; }
        .waiting-state .icon { animation: none !important; }
        .fade-in, .fade-out { animation: none !important; }
        .host-photo-fade-in, .host-photo-fade-out { animation: none !important; }
        .logo-badge, .logo-badge::before, .logo-badge i { animation: none !important; }
        .event-title::before, .event-title::after, .event-title .highlight,
        .event-title .highlight::after, .floating-heart { animation: none !important; }
    }
</style>
</head>
<body>
...
<div class="particles-container">
    <div class="particle-advanced heart">❤</div>
    <div class="particle-advanced heart">💕</div>
    <div class="particle-advanced heart">❤</div>
    <div class="particle-advanced heart">💕</div>
    <div class="particle-advanced heart">❤</div>
    ...
    <div class="particle-advanced heart">❤</div>
    <div class="particle-advanced heart">💕</div>
    <div class="particle-advanced shooting-star"></div>
    <div class="particle-advanced shooting-star"></div>
    <div class="particle-advanced shooting-star"></div>
    <div class="particle-advanced shooting-star"></div>
    <div class="particle-advanced shooting-star"></div>
...
<div class="hero-content">
    ...
    <div class="left-column">
        ...
        <!-- ⭐ NOM DE L'ÉVÉNEMENT AVEC EFFETS AMOUR -->
            ...
            <div class="host-photo-wrapper" id="hostPhotoWrapper">
                <?php if (!empty($hostPhotoUrls) && $hostPhotoUrls[0] !== 'default'): ?>
                    <img src="<?php echo htmlspecialchars($hostPhotoUrls[0], ENT_QUOTES, 'UTF-8'); ?>"
                         ...
                         id="hostPhotoImg"
                         onerror="this.style.display='none'; this.parentElement.innerHTML='<div class=\'logo-placeholder\'><i class=\'bi bi-calendar2-heart-fill\'></i></div>'">
                <?php else: ?>
                    <div class="logo-placeholder" id="hostPhotoPlaceholder">
        ...
        <?php if ($evenementInfo && !empty($evenementInfo['date_evenement'])): ?>
            <div class="event-date">
                ...
                <span>
                    <strong><?php echo htmlspecialchars($evenementInfo['lieu'] ?? 'Mariage', ENT_QUOTES, 'UTF-8'); ?></strong>
                    <span class="sep">•</span>
    ...
    <div class="right-column">
        ...
        <div class="logo-badge">
            <i class="bi bi-star-fill"></i> Bienvenue <i class="bi bi-star-fill"></i>
        </div>
...
<div class="refresh-counter" id="refreshCounter">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('mousemove', function(e) {
        ...
        if (container) {
            container.style.transform = `translate(${x * 0.03}px, ${y * 0.03}px)`;
        }
    });
});
