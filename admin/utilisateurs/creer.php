...
requirePermission('utilisateurs.creer');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (strlen($password) < 6 && !empty($password)) $errors[] = 'Le mot de passe doit contenir au moins 6 caractères';
    ...
    if (empty($errors)) {
        try {
            ...
            $stmt = $pdo->prepare("
                INSERT INTO utilisateurs (nom, prenom, username, email, mot_de_passe, actif, created_at)
                VALUES (?, ?, ?, ?, ?, ?, NOW())
            ");
            $stmt->execute([$nom, $prenom, $username, $email, $hashedPassword, $actif]);
            $userId = $pdo->lastInsertId();

            // Attribution du rôle (UN SEUL RÔLE)
            ...
            // Journaliser
            logAction($user['id'], 'CREATE_USER', 'utilisateurs', "Création de l'utilisateur $username (ID: $userId)");
...
<head>
    ...
    <title>Ajouter un utilisateur - <?php echo APP_NAME; ?></title>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="top-bar">
            <div class="page-title">
                ...
                <small><i class="bi bi-person"></i> Créer un nouveau compte</small>
            </div>
            <div class="user-info">
        ...
        <div class="content-section">
            <div class="form-container fade-in">
                ...
                <h5 class="form-title"><i class="bi bi-person-plus"></i> Nouvel utilisateur</h5>
                ...
                <form method="POST" action="">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="bi bi-lock"></i> Mot de passe <span class="text-danger">*</span></label>
                            <input type="password" class="form-control" name="password" placeholder="Minimum 6 caractères" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="bi bi-lock"></i> Confirmer le mot de passe <span class="text-danger">*</span></label>
                            <input type="password" class="form-control" name="password_confirm" placeholder="Confirmez le mot de passe" required>
                        </div>
                    </div>

                    <!-- SÉLECTION DU RÔLE (UN SEUL) -->
                    <div class="mb-3">
